...
public class DepartmentController {
	...
	public ResponseEntity<List<Department>> findAll() {
		...
		return new ResponseEntity<>(allDepartments, HttpStatus.NOT_FOUND);
	...
	// curl -v --request POST --header "Content-Type: application/json" --header "Accept: application/json" --data-raw "{\"name\": \"departmento de administracao\"}" "http://localhost:8080/departments"
